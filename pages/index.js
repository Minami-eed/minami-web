    ...
    <Container>
      ...
      <Section delay={0.1}>
        ...
        <Paragraph>
          ...
          development technologies including databases, frameworks, and version
          control tools. Additionally, I have experience in user interface
          design, user experience optimization, and the use of ChatGPT.<br></br>
          <br></br>
          ...
          effective communicator and take pride in my ability to translate user
          requirements into effective technological solutions.<br></br>
          <br></br>
      ...
      <Section delay={0.3}>
        ...
        <List>
          ...
          <ListItem>
            <Link href="https://www.instagram.com/minami.eed/" target="_blank">
              <Button
                variant="ghost"
                style={{ color: '#805ad5' }}
